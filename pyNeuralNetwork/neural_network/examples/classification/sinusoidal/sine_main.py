...
trainer.run()
trainer.generate_loss_plot(title=f'sine_epochs_{num_epochs}')
trainer.generate_scatter(title=f'sine_epochs_{num_epochs}')
validator.generate_scatter(title=f'sine_epochs_{num_epochs}')

# Running the tester and generating some plots
tester.run()
tester.generate_confusion()
tester.generate_scatter(title=f'sine_epochs_{num_epochs}')
