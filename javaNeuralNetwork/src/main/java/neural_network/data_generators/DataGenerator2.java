 ...
 */
public abstract class DataGenerator2<T> {
     ...
     */
    public DataGenerator2(int numDatapoints) throws NoSuchMethodException {
        this.function = DataGenerator2.class.getDeclaredMethod("function",
                double[].class);
    ...
    /** THIS FUNCTION MUST BE OVERRIDDEN BY THE USER.
     ...
     *
     * @param coordinates The x coordinates of the datapoint.
     * @return The class/regression value of the datapoint.
     */
    public abstract T function(double... coordinates);
